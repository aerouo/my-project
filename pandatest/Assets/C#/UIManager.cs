...
public class UIManager : MonoBehaviour
{
    ...
    public SlotHandler slotSwitch, slotCase, slotDefault;
    ...
    public void CheckResult()
    {
        ...
        bool isPlacementCorrect =
            slotSwitch.currentSticker?.GetComponent<DragHandler>().buttonType == "switch" &&
            slotCase.currentSticker?.GetComponent<DragHandler>().buttonType == "case" &&
            slotDefault.currentSticker?.GetComponent<DragHandler>().buttonType == "default";
    ...
    private void ResetSlot(SlotHandler slot)
    {
