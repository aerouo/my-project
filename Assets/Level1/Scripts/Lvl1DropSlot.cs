...
public class Lvl1DropSlot : MonoBehaviour, IDropHandler
{
    ...
    private Lvl1DragBlock currentBlock;
    ...
    public void OnDrop(PointerEventData eventData)
    {
        ...
        Lvl1DragBlock block = eventData.pointerDrag.GetComponent<Lvl1DragBlock>();
        if (block == null)
        {
