...
/// </summary>
public class Lvl2PuzzleSlot : MonoBehaviour, IDropHandler
{
    ...
    public void OnDrop(PointerEventData eventData)
    {
        ...
        Lvl2PuzzlePiece piece = eventData.pointerDrag?.GetComponent<Lvl2PuzzlePiece>();
