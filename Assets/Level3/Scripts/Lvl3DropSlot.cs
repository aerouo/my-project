...
public class Lvl3DropSlot : MonoBehaviour, IDropHandler
{
    ...
    private Lvl3DragBlock currentBlock;
    ...
    {
        Debug.Log("OnDrop 觸發！");
        Lvl3DragBlock block = eventData.pointerDrag?.GetComponent<Lvl3DragBlock>();
