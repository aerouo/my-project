...
public class Lvl5DropSlot : MonoBehaviour, IDropHandler
{
    ...
    private Lvl5DragBlock currentBlock;
    ...
    {
        Debug.Log("OnDrop 觸發！");
        Lvl5DragBlock block = eventData.pointerDrag?.GetComponent<Lvl5DragBlock>();
